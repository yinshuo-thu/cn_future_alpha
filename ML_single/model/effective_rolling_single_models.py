...
def predefined_variants(preset: str) -> list[Variant]:
    ...
    lgbm = [
        ...
        Variant(
            "lgbm_union927_ranknorm_cons_soft_n300k",
            "lgbm",
            "union927",
            "label_ranknorm",
            300_000,
    ...
    codex_opt = [
        Variant(
            "lgbm_overlap333_xsz_event35_n900k",
            "lgbm",
            "overlap333",
            "label_xsz",
            900_000,
        ...
        Variant(
            "lgbm_overlap333_xsz_event50_n900k",
            "lgbm",
            "overlap333",
            "label_xsz",
            900_000,
        ...
        Variant(
            "ridge_overlap333_xsz_hl12_n900k_a02",
            "ridge",
            "overlap333",
            "label_xsz",
            900_000,
...
def main() -> None:
    ...
    parser.add_argument("--preset", choices=["ridge", "quick", "lgbm", "heavy", "opt", "all", "codex_opt"], default="quick")
