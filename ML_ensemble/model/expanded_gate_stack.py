...
from rolling_factor_model_eval import period_ic
...
def main() -> None:
    ...
    out.to_parquet(OUT_DIR / "stack_selected.parquet", index=False)
    period_ic(out, "pred", "M").rename("ic").reset_index().to_csv(OUT_DIR / "stack_selected_monthly_ic.csv", index=False)
